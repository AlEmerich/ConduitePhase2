...
<div class="modal fade" id="modalAddUS" tabindex="-1" role="dialog" aria-labelledby="modalAddUSLabel">
	...
	<div class="modal-content">
	    ...
	    <form action="http://localhost:8000/php/addRemoveUSFromSprint.php?sprint_id=<?php global $sprint_id; echo $sprint_id; ?>&project_id=<?php global $project_id; echo $project_id; ?>" class="list-group" method="post">
