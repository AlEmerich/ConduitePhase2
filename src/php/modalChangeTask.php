...
?>
	...
	<div class="modal-dialog" role="document">
		...
		<form action="<?php echo $GLOBALS['SITE_ROOT']; ?>/php/sprintSingle.php?project_id=<?php global $project_id; echo $project_id; ?>&sprint_id=<?php global $sprint_id; echo $sprint_id; ?>&tab=2"
